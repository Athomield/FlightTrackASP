        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Longitude = table.Column<decimal>(type: "TEXT", precision: 10, scale: 6, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "FlightStatusUpdates",
                columns: table => new
                {
                    FlightStatusUpdateId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Status = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightStatusUpdates", x => x.FlightStatusUpdateId);
                    table.ForeignKey(
                        name: "FK_FlightStatusUpdates_Flights_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TrackedFlightId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    FlightId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackedFlights", x => x.TrackedFlightId);
                    table.ForeignKey(
                        name: "FK_TrackedFlights_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightStatusUpdates_FlightId",
                table: "FlightStatusUpdates",
                column: "FlightId");
